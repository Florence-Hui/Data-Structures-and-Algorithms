...
### Other Learnings
- During the testing, I initially encountered an error message:
     ```text
     Kotlin: Unresolved reference 'checkSortedResult'
  ```
   I found out that this was due to coupling the algorithmic logic directly with terminal I/O inside the solution loop, and I resolved it by isolating them into two layes: a pure function and an I/O irchestrator. This reminded me that the core computational rules must remain independent from the terminal streams.
